...
class Empleado(ABC):
    ...
    def __str__(self):
        '''
        Retorna cadena que representa al empleado.
        '''
    ...
    def total():
        '''
        Método estático que devuelve la cantidad de instanciaciones de la clase.
        '''
...
def main():
    ...
    empleados.append(EmpleadoAsalariadoComision(10, 3000000,
                                                6000000, 20,
                                                'Empleado',
                                                'AsalariadoComision'
                                                ))
